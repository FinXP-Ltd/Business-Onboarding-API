...
class BusinessDraftTest extends TestCase
{
    ...
    public function testShouldSetBusinessToDraft()
    {
        ...
        $withdrawn_business = $this->getBusinessPayload();
        ...
        $this->impersonate(credential: $imposter, guard: 'auth0-api')
            ->putJson(route('business.draft', $b->id), $withdrawn_business)
    ...
    public function testShouldNotSetBusinessToDraftIfItsNotWithDrawn()
    {
         $authUserToken = $this->getTokenPayload('agent');
